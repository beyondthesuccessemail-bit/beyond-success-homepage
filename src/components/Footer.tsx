  ...
  <footer className="bg-navy-deep border-t border-border px-6 py-12">
    <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
      <div>
        ...
        <a href="mailto:hello@becomingthesuccess.com" className="text-muted-foreground text-xs font-body hover:text-gold transition-colors mt-2 block whitespace-nowrap">hello@becomingthesuccess.com</a>
      </div>
      <div>
