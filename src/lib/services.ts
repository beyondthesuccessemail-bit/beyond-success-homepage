...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    heroDescription: "We don't just design websites — we engineer digital platforms built for growth. Every site we create is crafted from scratch with clean code, blazing-fast load times, and a structure purpose-built for search engine optimisation and pay-per-click advertising. Whether you need a brand-new site or a complete rebuild, we deliver a website that looks world-class and works even harder behind the scenes.",
